const OurWork = () => {
  const work = {
    column1: [
      ...
      {
        id: 2,
        title: "Soulmate-’Social’ Relationship Platform Based on AI & ML",
        content: "UI/UX Design, Website & Mobile App Development.",
    ...
    column2: [
      {
        id: 1,
        title: "GoldSouk.com-Enterprise Platform ",
        content: "UI/UX Design. Website & Mobile App Development.",
        image: require("../../assets/images/our-work/passio.webp"),
      },
      {
        id: 2,
        title: "Metaverse for NFT Auction House",
        content: "UI/UX Design, Website & Mobile App Development.",
      ...
      <div className="flex flex-col justify-between lg:flex-row">
        ...
        <div className="w-full lg:w-[49%]">
          {work?.column2.map((item) => (
            <div key={item.id} className="py-5 scale-box-container">
              <div className="img-box">
                <img src={item.image} alt="" />
              </div>
              <div className="pt-2">
